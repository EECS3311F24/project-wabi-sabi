...
## Tracking on Trello  (max 24 marks) 
  ...
  - Do the pull request on GitHub match the tasks listed on Trello Active Sprint Board? (max 2 marks)
  ...
  - Burndown chart (max 2 marks)
    - 2 marks = burndown chart present, matched Trello, and explantions are adequate.
    - 1 mark  = burndown chart present, matches Trello, but no explanations provided, or explanations are not adequate.
...
---
## Workload distribution in time (Max 20 marks) 
  - First week 
    - full marks (20) = a minimum of 30% of commits are made during week 1 of the sprint
    - 10 marks = more than 15% (but less than 30%) of commits are done week 1
    - 0 marks = less than 15% of commits are done during week 1
